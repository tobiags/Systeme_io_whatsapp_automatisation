...
SOURCE = ROOT / "HANDOFF-CLIENT-CHALLENGE-AMAZON-FBA.md"
OUTPUT = ROOT / "HANDOFF-CLIENT-CHALLENGE-AMAZON-FBA.docx"
...
def add_cover(doc: Document) -> None:
    ...
    run = p.add_run("Challenge Amazon FBA - WhatsApp Automation")
    run.font.name = "Aptos"
    run.font.size = Pt(14)
    run.font.bold = True
    ...
    rows = [
        ("Project", "Challenge Amazon FBA"),
        ("Document", "Client handoff + operating procedures"),
        ("Audience", "Operations team / closers / owner"),
