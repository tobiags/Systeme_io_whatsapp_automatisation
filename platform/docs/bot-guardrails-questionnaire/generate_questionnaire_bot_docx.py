...
SOURCE = ROOT / "QUESTIONNAIRE-CADRAGE-BOT-WHATSAPP.md"
OUTPUT = ROOT / "QUESTIONNAIRE-CADRAGE-BOT-WHATSAPP.docx"

ACCENT = RGBColor(0x14, 0x6C, 0x43)
ACCENT_LIGHT = "EAF6EE"
BORDER = "C9D3DD"
...
def add_cover(doc: Document) -> None:
    ...
    run = p.add_run("Questionnaire de Cadrage")
    ...
    run = p.add_run("Bot WhatsApp - Challenge Amazon FBA")
    run.font.name = "Aptos"
    run.font.size = Pt(14)
    run.font.bold = True
    ...
    rows = [
        ("Document", "Questionnaire client de cadrage"),
        ("Objet", "Prompt, guardrails, ton, périmètre, escalade"),
        ("Audience", "Client / propriétaire / équipe commerciale"),
