...
SOURCE = ROOT / "PROPOSITION-PHASE-2-MEMOIRE-PERSISTANTE-IA.md"
OUTPUT = ROOT / "PROPOSITION-PHASE-2-MEMOIRE-PERSISTANTE-IA.docx"
...
def add_cover(doc: Document) -> None:
    ...
    run = p.add_run("Proposition Phase 2")
    ...
    run = p.add_run("Memoire Persistante IA")
    run.font.name = "Aptos"
    run.font.size = Pt(15)
    run.font.bold = True
    ...
    rows = [
        ...
        ("Type", "Proposition d'evolution phase 2"),
