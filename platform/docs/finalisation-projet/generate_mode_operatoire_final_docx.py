...
SOURCE = ROOT / "MODE-OPERATOIRE-FINAL-CHALLENGE-AMAZON-FBA.md"
OUTPUT = ROOT / "MODE-OPERATOIRE-FINAL-CHALLENGE-AMAZON-FBA.docx"
...
def add_cover(doc: Document) -> None:
    ...
    run = p.add_run("Mode Operatoire Final")
    ...
    rows = [
        ...
        ("Document", "Passation et exploitation"),
        ("Usage", "Mode operatoire client final"),
